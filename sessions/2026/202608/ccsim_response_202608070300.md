...
- 128.5. Measured cost of your preference: 522 → 578 hits (+11%), against a 970-hit ceiling if I go fully literal on "ANY read". I stopped short of maximal —— `#r` cannot replace `re-read` or "the Read tool" —— and give you the number rather than deciding.
