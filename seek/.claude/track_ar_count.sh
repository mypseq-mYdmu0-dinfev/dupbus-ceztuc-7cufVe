...
# CCIC-GCL AR Counter & S0.3 Re-Read Enforcer
...
# into context at every multiple of 5 (enforcing S0.3 compliance).
...
# Inject ccic_gcl.md at every multiple of 5 (S0.3)
if [[ $((NEW_COUNT % 5)) -eq 0 ]]; then
    echo ""
    echo "==================================================================="
    echo "MANDATORY RE-READ — S0.3 TRIGGERED (N=${NEW_COUNT})"
    echo "Per ccic_gcl.md S0.3: re-read ccic_gcl.md in full before next card."
