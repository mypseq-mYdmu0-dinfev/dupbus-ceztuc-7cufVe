# Duo Group — Senior Marketing Executive
- **Date:** 22:22 on 19/06/2026
- **SEEK URL:** https://au.seek.com/job/92776379
- **Outcome:** Applied (Interview at 202606301300)
- **Resume Selected:** Culous_Yu_Resume_Marketing.pdf
- **Suitability Score Breakdown:**
1. Qualification Sufficiency — 14/30 (marketing exec gap; transferable comms skills)
2. Role Sufficiency — 10/20 (not career-aligned; strong adjacent skills)
3. Sector fit — 5/15 (property services, non-core)
4. Growth Value — 4/10 (small local brand)
5. Employer Quality — 6/10 (legitimate, growing, stable)
6. CL Differentiability — 4/10 (limited; job post only)
...
### 1.2. Group Structure & Divisions
- 1.2.1. Four divisions (matching the email footer): **Duo Tax** (Depreciation, flagship); **Duo Tax Property Valuations** (CPV registered valuers); **Duo QS & Estimators** (construction cost estimating); **Duo Insurance** (property insurance).
- 1.2.2. Per the live ad, the seat sits in the **in-house marketing team supporting multiple brands**, Duo Tax foremost —— so it is a multi-brand remit, not Duo Tax alone.

### 1.3. Founder & Leadership
- 1.3.1. **Tuan Duong —— Principal & Founder.** Ex-civil engineer / building economics; became a property investor first, then a depreciation specialist (the firm's origin story). **Registered Tax Agent** (Tax Practitioners Board); **AIQS Affiliate**. Public title is "Principal & Founder", not CEO/MD; no separate CEO is named.
- 1.3.2. He is a media asset in his own right (Money magazine columns, frequent podcast/YouTube guest) —— founder-led content is a core channel, directly relevant to this role.
...
### 1.6. Services, Credits & Claim Governance ⚠️
- 1.6.1. Customer proof is genuinely strong: **Trustpilot 4.9/5 "Excellent", 1,857 reviews** (claimed profile, paid Trustpilot subscription) [CIC ✅]; positioned on-site as **"Australia's most reviewed and highly-rated Quantity Surveyors"** [CIC ✅]. (A Google ~687 five-star count is triage-only [⚠️ not CIC-verified].)
- 1.6.2. Credibility markers [all CIC ✅]: **ATO compliant**; directors are **AIQS Affiliate** members (affiliate, not full corporate registration); ~$13,000 average first-FY claim ($68,495 over 10 yr); ~5-business-day turnaround; up to 40-year forecasts.
- 1.6.3. 🚩 **CIC-confirmed claim inconsistency (a clean talking point for a marketing hire):** the investors-served count reads **"over 170,000+"** on the duotax.com.au homepage but **"over 100,000"** on its own /about page [both CIC ✅]. A single source of truth for headline numbers is an obvious early win —— raise it diplomatically, never as a lecture (see §5B.6).

### 1.7. Marketing & Content Footprint
- 1.7.1. ⚠️ Channel list is triage (not yet CIC-walked): YouTube @DuoTax, "The Duo Tax Podcast", Instagram @duotaxqs, Facebook /duotax, an on-site SEO blog, plus founder-led thought leadership. Follower counts (IG ~3k, LinkedIn ~1.8k) are triage-only.
- 1.7.2. CIC-confirmed framing: education-led, investor-empathy content ("as a team of property investors ourselves") [CIC ✅] —— against a 100k–170k servicing base, the role clearly owns a **growth/scale mandate**.
...
- Strong written comms — ✅ strength
- Digital campaigns, social media, email marketing, content — partially transferable
- Social platforms incl. Reddit for community insight — partial
- Campaign reporting and performance analysis — ✅ transferable
- CRM/email/marketing automation tools — partial
- Property/real estate/finance industry exp — not directly
- Bachelor's in Marketing/Communications/Business preferred — ✅ (MBA, UTS HD)

## 3. Application Tailoring
- Lead with cross-industry content and campaign coordination experience to position as versatile marketer
- Emphasise stakeholder management and brief-to-delivery ownership as senior-level differentiator
- Reference B2B and B2C exposure across diverse industries as strategic breadth
- Highlight analytical and performance-tracking acumen to address the campaign reporting requirement
- Do not over-claim marketing execution depth; frame as senior strategic layer complementing hands-on execution

**Employer Questions Answered (S6.2):**
- Right to work in Australia → "I have a graduate temporary work visa"
- Years as marketing executive → "More than 5 years" (content/campaign mgmt cross-career)
- Years in marketing role → "More than 5 years"
- Expected annual base salary → "$70k" (score 48 < 85; nearest ≤ $75k)
- Notice period → "None, I'm ready to go now"

## 4. Noteworthy Aspects
- Full office-based role (5 days/wk, Homebush) — long commute consideration
- "Responsive hirer" badge on SEEK — faster turnaround expected
- Medium application volume — competitive but not saturated

## 5. Interview Prep
*Pre-interview prep for the on-site 30-min screen, Tue 30/06/2026 1:00pm. Sole named interviewer: Kim Quach (Marketing Manager). The assessment is already delivered and well-received (§7), so expect it to anchor the conversation.*

### 5A. Likely Interviewer Questions (anticipate)
- 5A.1. "Walk me through your background" —— plus the over-qualification probe (GM/consulting to a senior IC marketing seat). Own it: a deliberate move into hands-on AU marketing and local experience (mirror the Rennly/Alltech framing; never disclose KE founding).
- 5A.2. "Why Duo Tax / Duo Group?" —— education-led content model, strong customer trust (4.9 Trustpilot), a clear growth stage, and a builder-friendly marketing function.
- 5A.3. (From the original §5 / the ad) "How would you build a content calendar and social plan for a specialist property brand like Duo Tax?"
- 5A.4. "Tell me about running multiple simultaneous campaigns —— how did you prioritise?"
- 5A.5. "How do you measure digital-campaign success, and what reporting tools have you used?"
- 5A.6. 🎯 "How does marketing drive qualified enquiries here?" —— Kim's commercial lens; connect creative to pipeline to schedules sold.
- 5A.7. "Talk us through your assessment —— why those channels, why those metrics?" (see §5E).
- 5A.8. "How do you write persuasive property/tax copy without guaranteed-savings claims or tax advice?" —— the assessment's hidden compliance test, which he passed.
- 5A.9. "Which CRM / email / marketing-automation tools have you used?" —— a partial gap; be honest, frame fast adoption and systems thinking.
...
- 5B.2. "How is the marketing team structured, and how would this role work with you and across the brands (Tax, Valuations, QS, Insurance)?"
- 5B.3. "What is the priority for the first 90 days?"
- 5B.4. "How does marketing currently connect to the enquiry/sales funnel —— what is tracked, and what is the reporting cadence?" (plays to her commercial lens)
...
- 5D.1. **Lead differentiator:** a senior cross-industry marketer who ties creative to commercial outcomes —— exactly Kim's likely lens. Anchor on 16⁺ yr content/PM, 300⁺ projects, 100⁺ clients across B2B/B2C/NPO/Govt (marketing/content specifics ARE allowed here —— it is a marketing role).
- 5D.2. **Builder framing:** built the marketing function, systems, and reporting ground-up at KE (GM/leadership tenure —— NEVER disclose founding). Use "Strategic Transformation, Value Engineering, Stakeholder Management".
- 5D.3. **Assessment as proof:** the well-received brief already shows he gets the business —— depreciation misconception to qualified enquiries, compliant copy, benchmark-relative metrics. Reuse that thinking live; let it carry the over-qualification question.
- 5D.4. **Honest gap-handling:** the 4–5 yr AU-marketing and property/finance-sector gaps —— bridge with breadth, the assessment, and fast domain pickup; frame as the senior strategic layer complementing hands-on execution, and do not over-claim execution depth. Keep consistent with the lodged "5⁺ years" marketing-exec answer.
- 5D.5. **Compliance literacy:** he demonstrated ATO-compliant, no-guarantee copy in the assessment —— a real differentiator for a regulated tax/property audience.
- 5D.6. ⚠️ **Salary:** lodged $70k (S6.2 filter) but the live band is **$90–120k + super**. Do **NOT** reaffirm $70k verbally; if pressed, "the listing's $90–120k range feels right for the scope", and defer hard numbers to offer stage —— let them frame first (mirrors Alltech §5D.1).
...
- 5E.2. **Channels:** Google Search (high-intent), Meta (interest plus database lookalikes), LinkedIn (referral partners), an EOFY email (existing contacts), with Reddit/forums monitored for insight —— each maps to a funnel stage.
- 5E.3. **Metrics:** qualified enquiries plus cost per qualified lead vs Duo Tax's historic baseline; secondarily enquiry-to-schedule conversion —— deliberately benchmark-relative, NOT invented funnel numbers (defensible as candidate-side discipline).
- 5E.4. **Key message / compliance:** "older or renovated properties may still hold depreciation potential", with no guaranteed savings and no personal tax advice (the hidden test).
- 5E.5. ⚠️ Open thread: the task ended at Task 2A; a Task 2B was never explicitly closed. If Kim asks for more copy, it is a quick incremental, not a gap in the original submission.

## 6. Cover Letter

Dear Hiring Manager,

I am writing to express my strong interest in the Senior Marketing Executive position at Duo Group. With my proven expertise and signature strengths in Strategic Transformation, Value Engineering, and Stakeholder Management (Virtual Presentation: http://Presentation.CulousYu.com), I am exceptionally well-positioned to contribute to Duo Group's mission of driving brand awareness, lead generation, and business growth across its property services portfolio.

My background in content and project management across B2B and B2C environments has honed my skills in multi-channel campaign coordination, copy creation, and performance analytics. I am particularly drawn to Duo Group's in-house marketing model and its commitment to building client trust through education-led communications, a philosophy that speaks to my own approach to audience engagement.
...
I am more than excited by the prospect of devoting my expertise to Duo Group and contributing to its ambition of becoming the definitive support network for Australian property investors through compelling, data-informed marketing.

Thank you for considering my application. I look forward to discussing how my skills and experience may contribute to the continued success of Duo Group.
...
On 26 Jun 2026, at 10:51, Alfredo Agustin <alfred@duogroup.com.au> wrote:

Dear Culous,
 
We are pleased to invite you for an on-site interview for the Sr. Marketing Executive position within our Duo Group Division.
 
Interview Details:
Date: Tuesday, 30th June 2026
Time: 1:00 pm (30-minute duration – Please arrive 10 minutes before your interview time)
Location: Unit 34, 11-21 Underwood Rd, Homebush
(Next to Sneakies Cafe, near the boom gates at the front of the complex)
 
Interview Panel:
Kim Quach – Marketing Manager
 
On-site HR contact:
Eva – 0418 346 172
 
Dress Code:
Smart business attire. Please note that sneakers and hoodies are not permitted.
 
Parking:
Free 2-hour parking is available next door at the DFO Outlet Centre, Homebush or Mason Park Sporting Field, Underwood Rd.
 
Please allow an extra 10 minutes to find parking.
  
Public Transport:
You can alight at either North Strathfield or Homebush Station, then take a bus or Uber to Underwood Rd.
...
[INTERNAL: attached `Culous_Yu_Resume_Marketing.pdf`]

### User Reply

[INTERNAL: cc Kim Quach, Jason Futrill]

On 26 Jun 2026, at 10:55, Culous Yu <culousyu@gmail.com> wrote:

Hello Alfred,

Thank you for the invite. Well acknowledged.

Dear Kim,

If there is anything I shall prepare in advance, please do not hesitate to let me know. Thank you for your time!
