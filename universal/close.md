...
## 7. SHA
> [enumerate all SHAs (8char each; per root §3.2.4.3) of whole session on single line]
> [only emit multiple lines if multiple repos touched; follow root CLAUDE.md §3.2.4.5]
```
