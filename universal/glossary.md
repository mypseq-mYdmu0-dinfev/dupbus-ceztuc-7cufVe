...
- Standfirst = *italic/slanted* one-liner below top heading & above body (typically 1st section)
  - MUST be ≤90chars (inc. space): don't aim to use up quota, but as short as feasible
  - If >90chars: create a § Preamble w/ pts (not a long, unreadable one-liner)
