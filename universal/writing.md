...
- If multiple cited sources from identical author and year, use `Author, Year-a` `Author, Year-b`
- If multiple cited sources from identical author and no date, use `Author, n.d.-a` `Author, n.d.-b`
- For example: "NASA (n.d.-a) found... and XXX... (NASA, n.d.-b)."