...
* IMPORTANT: Each prompt file fetched ONCE per chat only. When ANYTHING fetched, declare in chat (e.g. `✅ 1.md, 2.md`). STOP & alert if any fetch failed, do not proceed.

## UNCONDITIONAL

- Fetch at every chat start & resolve all filenames below using directory.md: https://raw.githubusercontent.com/mypseq-mYdmu0-dinfev/dupbus-ceztuc-7cufVe/main/universal/directory_11.md
