...
When we're on high-stake but lengthy tasks and both A/BCIC don't suffice, consider suggesting CCIC. If committed, start by asking for existing CCIC CPs' prompts.
