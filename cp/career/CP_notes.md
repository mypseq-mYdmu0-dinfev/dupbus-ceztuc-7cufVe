...
## Remarks
- IMPORTANT: NO FALSE CLAIMS; e.g. ✅ `16⁺yr in content & project mgmt` (generic) | ❌ `16⁺yr in [industry]/[other_domain]` (specific); check CP files (e.g. career_bg.md § Domain Exp)
...
- Culous frames himself (strictly internal, never performed as dominance in interviews) as a "chameleon veteran": cross-domain code-switcher who earns authority on the counterpart's weak axis; humble-by-default posture (AU tall-poppy). Full cards & rationale: `sessions/2026/202606/career_close_202606162244.md` §6.