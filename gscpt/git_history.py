...
def main() -> None:
    ...
    out.write_text(
        ...
        "</header>"
        "<div id='helpbox'>- Newest first<br>- Click a commit to expand<br>"
        "- Click a SHA chip to copy it + open the commit on GitHub<br>"
        "- HTML view = the file as rendered rich text after that commit<br>"
        "- Code view = word-level diff vs the previous commit<br>"
        "- Dark Mode follows your macOS setting by default</div>"
        "<div id='toast'></div>"
