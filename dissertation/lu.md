...
On 9 May 2026, at 04:03, Culous Yu <Culous.Yu@liverpool.ac.uk> wrote:

Hello Lu,

I have been working through the shared folder since you've very kindly provided to me and found the materials truly useful, particularly the methodology references and the case study & IPA variants.

After reviewing both sides in detail, I have settled on an explanatory multiple-case study design (Yin, 2009; Zainal, 2007). I confess that I found myself genuinely torn at first, as the current proposal carries some elements that inadvertently reads closer to IPA; working through your materials made the distinction clear. The explanatory case study logic is the right fit for a conditions-oriented, cross-organisational study.

On framing: I am proceeding with Culous Yu Consultancy (CYC), a simulated management consulting firm (MCF) specialising in knowledge management (KM), with participant sampling drawn from KBFs broadly as CYC's primary client base. This reflects the two-dimension distinction you raised at our last meeting.

The refined research proposal is underway and will be aligned with your guidance. I had a busy week and am now working days and nights to send you the new draft ASAP.
...
On 9 May 2026, at 04:19, Liu, Lu [luliu99] <Lu.Liu@liverpool.ac.uk> wrote:

Very well done, Culous. I am very glad to know that you are clearer and more confident about what you plan do. So far, I do not have any questions. Please follow your idea to complete the proposal. I look forward to reading it. 
...
On 17 May 2026, at 21:01, Culous Yu <Culous.Yu@liverpool.ac.uk> wrote:

Hello Lu,

Thank you for your warm and encouraging words in your last email. The refined research proposal is now complete. Please find it attached as "MGTK751 _ A1R _ 202605162207.pdf", which was also uploaded to the shared folder.

The revisions address your guidance from our first meeting:

1. The Firm
CYC (Culous Yu Consultancy) is introduced in §1 as a simulated MCF (management consulting firm) specialising in KM (knowledge management), with participants drawn from KBF (knowledge-based firms) broadly as its primary client base.

2. Sequence
§1 now presents the research aim, then research questions, and finally research objectives, as you advised.

3. Literature Structure
§1 carries equal academic and practitioner sources, with Australian-specific evidence added. §2 follows a TPS foundation → TPS in KM → TPS in KBF → TPS in AU KBF thread, supported exclusively by academic sources.

4. Research Method
§3 now articulates an explanatory multi-case study (Yin, 2003; Zainal, 2007) as the research method, with semi-structured interviews positioned as the data collection technique within it, correcting the structural omission in the original submission.

5. Register & Scope
Both §1 and §3 are drafted at the final paper's (A3) register for direct use as Chapters 1 and 3; sitting at 819 and 838 words respectively. I have included a pre-drafted "Structure of Chapters" at the end of §1 to show the proposed structure of A3's Chapter 1. Please do advise whether you would prefer this removed before the proposal reaches the reviewers, since the referred “Chapters” don’t exist yet.

I look forward to your thoughts at your convenience and am ready to perform further refinement if needed.

Warm Regards,
Culous Yu
(MGTK751)

<MGTK751 _ A1R _ 202605162207.pdf>

### Log 10

On 17 May 2026, at 23:34, Liu, Lu [luliu99] <Lu.Liu@liverpool.ac.uk> wrote:

Well done, Culous. Could you please send me a Word document to allow me to add my comments to the file? 
...
On 18 May 2026, at 03:11, Yu, Culous <Culous.Yu@liverpool.ac.uk> wrote:

Hello Lu,

No problem. I have uploaded the .docx onto the shared folder as well as attaching here as "MGTK751 _ A1R _ 202605162207.docx". I am grateful for your detailed guidance.

Regards,
Culous

<MGTK751 _ A1R _ 202605162207.docx>

### Log 12

On 23 May 2026, at 08:31, Liu, Lu [luliu99] <Lu.Liu@liverpool.ac.uk> wrote:

Sorry, Culous, for taking a couple of days to complete the review. I have completed the review and have uploaded it to our shared folder. 
​proposal-1-C Liu.docx​ (URL)
I also uploaded a new source for thematic analysis in the research methods reference folder. 
​Using thematic analysis in psychology.pdf​ (URL)
If you feel a meeting is better for us to discuss the proposal, please let me know. I will organise it. 
...
On 26 May 2026, at 00:27, Culous Yu <Culous.Yu@liverpool.ac.uk> wrote:

Hello Lu,

Thank you very much for completing the review and for the additional reference, both are much appreciated.

I have gone through the returned proposal (proposal-1-C Liu.docx) carefully. Having compared it with the version I originally sent (MGTK751 _ A1R _ 202605162207.pdf), I could not find any edits or comments within the document. I also checked both the downloaded copy and the version opened directly through your shared folder link, and the result was the same on both interfaces.

Could you please kindly help me understand whether this means you are satisfied with the proposal as submitted and no changes are required from your end, or whether you intended to leave some feedback that may not have come through properly on the file? If latter (you intended to make comments), perhaps you may try to save as a PDF to ensure I see exactly what you see? A meeting is not strictly necessary unless you wish to, I simply want to fully comprehend your comments (if any).

Regarding the Braun and Clarke paper (Using thematic analysis in psychology.pdf) you shared, I have had a read through. As the proposal currently cites the 6-phase framework in passing, I would like to propose that, for the full dissertation (Chapter 3), I expand the data analysis section to walk through each of the six phases more explicitly, drawing on the paper to describe what was done at each step. This would give the methodology chapter the operational depth it warrants. Please do let me know if that is in line with what you had in mind when sharing it, or if you had a different application in mind, or you would prefer me to immediately embody this new reference in the current research proposal.

I look forward to your guidance on both points.
...
*Comments extracted verbatim below.*

#### CM1 (on §1 Intro; 20260525)
...
On 5 Jun 2026, at 06:03, Culous Yu <Culous.Yu@liverpool.ac.uk> wrote:
...
I would be grateful for your confirmation that this resolves the concern over compliance with "within your work organisation", or your thoughts on any further adjustment that may be warranted.

**Research Questions**

Reviewing the existing RQs against the revised aim, I found their cores remained well-suited to the new framing. RQ1 investigates the conditions within KBFs that exacerbate or alleviate TPS, which directly maps to the structural knowledge CYC requires to develop its product (consulting service in KBF contexts). RQ2 examines how team members experience TPS-related dynamics, providing the experiential evidence from which CYC's consulting offerings will ultimately be derived. Together, they address the revised aim from two complementary dimensions, covering the antecedent structural conditions of TPS risk as well as its operational manifestation within teams, which I believe captures the scope and boundary intended. I would, of course, be much obliged by any further guidance from you.
...
On sample size, the proposal currently states a minimum of 6 participants. Formally speaking, the quantity shall be determined by data saturation rather than headcount (Guest, Bunce and Johnson, 2006). Practically speaking, the final number could not be reliably predicted until data collection is in progress, which we're strictly prohibited from starting before approval. I did not wish to overpromise so I'd propose to keep as is if you agree. To clarify, my framing sits identical to the "6" of "6–8", but may not stop at a maximum of 8 if opportunities emerge.

**Conceptual Framework (Figure 1)**

Thank you for the note that the conceptual framework warrants greater detail, which I take to concern Figure 1. At the proposal stage it is presented as a deliberately provisional model, to be refined once the empirical findings emerge in keeping with the inductive design, though I am very willing to develop it now and would value your specific guidance so the revision targets precisely what you have in mind. For instance, would you prefer the figure to make the underpinning theoretical mechanisms more explicit (e.g. Social Comparison Theory, Social Exchange Theory, and the Knowledge-Based View, shown as labelled relationships between the domains), to articulate the conditions and sub-dimensions within each domain more fully, or to set out more clearly how the two research questions map onto its components? Any advice on the elements you would most expect to see represented would allow me to reconstruct the figure more precisely, and the resulting detail would serve the eventual A3 Chapter 2 equally well.
