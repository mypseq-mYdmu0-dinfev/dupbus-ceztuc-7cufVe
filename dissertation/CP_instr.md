...
- Fetch at every chat start & resolve all filename aliases below using CP_directory.md: https://raw.githubusercontent.com/mypseq-mYdmu0-dinfev/dupbus-ceztuc-7cufVe/main/dissertation/CP_directory_17.md
...
Conditionally fetch:
- `Official Files (distilled).md` if module info/ethics process needed
- `A1-3.md` if assessment info needed
- `Potential Advisors.md` if DA (Dissertation Advisor) info needed
